package ClasseAtividadeResposta;
...
#################################################################################
# ClasseAtividadeResposta
# criado  : 01/2004
# projeto : Gradenet.com.br
# autor   : Hermano Pereira
#--------------------------------------------------------------------------------
# Classe para criar e manipular objetos que controlam respostas de atividades
#################################################################################
...
# 0-codigoResposta, 1-codigoAtividade, 2-titulo, 3-Texto, 4-data, 5-nomeAnexo,
...
sub setDados {
   ...
   if (@_) {
      ...
      die "Nenhum argumento foi enviado para a resposta da atividade!";
   }
}
#################################################################################
...
# 0-codigoResposta, 1-codigoAtividade, 2-titulo, 3-texto, 4-nomeAnexo,,
# 5-codigoUsuario
#################################################################################
sub setDadosIU {
   my $self = shift;
